...
using LightEngineCore.PhysicsEngine.Factories;
using LightEngineCore.PhysicsEngine.Primitives;
using LightEngineCore.PhysicsEngine.Shared;
using LightEngineCore.PhysicsEngine.Tools.PolygonManipulation;
using LightEngineCore.PhysicsEngine.Tools.Triangulation.TriangulationBase;

namespace LightEngineCore.PhysicsEngine.Tools.TextureTools
{
    /// <summary>
