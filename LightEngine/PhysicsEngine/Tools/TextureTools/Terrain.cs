...
using LightEngine.PhysicsEngine.Factories;
using LightEngine.PhysicsEngine.Primitives;
using LightEngine.PhysicsEngine.Shared;
using LightEngine.PhysicsEngine.Tools.PolygonManipulation;
using LightEngine.PhysicsEngine.Tools.Triangulation.TriangulationBase;

namespace LightEngine.PhysicsEngine.Tools.TextureTools
{
    /// <summary>
